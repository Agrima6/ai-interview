        ...
        <div className='relative p-5 sm:p-7 lg:p-8'>
            <div className='relative grid gap-8 lg:grid-cols-[minmax(0,1.45fr)_minmax(210px,0.85fr)] lg:gap-0'>
                <div className='order-2 lg:order-1 lg:pr-8'>
                    ...
                    <div className='type-caption mt-7 flex flex-wrap gap-x-4 gap-y-2 border-t border-line pt-4 text-text-secondary'>
                ...
                <div className='order-1 border-b border-line pb-7 lg:order-2 lg:border-b-0 lg:border-l lg:pb-0 lg:pl-8'>
                    ...
                    <div className='relative mx-auto mt-5 h-[148px] w-full max-w-[218px]' aria-label={`Overall Fit ${overallScore}%`} role='img'>
                        ...
                        <div className='absolute inset-x-0 bottom-[33px] flex items-center justify-center'>
