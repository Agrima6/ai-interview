...
// Forced first-login step for candidate accounts, created with a
// system-generated temporary password (see the application confirmation email).
    ...
    return (
        <div className='min-h-screen bg-bg flex items-center justify-center px-6 py-16'>
            <Card className='w-full max-w-[420px] p-8 sm:p-10'>
                <h1 className='font-display text-[22px] font-bold text-ink mb-2'>Set a new password</h1>
                <p className='text-text-secondary text-[13.5px] mb-8'>
                    {user?.email ? `Signed in as ${user.email}. ` : ''}
                    You're using a temporary password - set your own before continuing to your room.
                </p>
