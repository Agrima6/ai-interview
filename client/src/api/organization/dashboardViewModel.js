...
export const toTrendsViewModel = (raw) => raw ? { pipeline: raw.pipeline || [], interviewTrend: raw.interviewTrend || [], scoreDistribution: raw.scoreDistribution || [], departmentBreakdown: raw.departmentBreakdown || [] } : null
